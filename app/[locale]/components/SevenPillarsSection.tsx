...
const PILLARS: PillarItem[] = [
  {
    ...
    num: "01",
    icon: Shield,
    img: withBasePath("/assets/images/pillars/cyber.jpg"),
  ...
  },
  {
    ...
    num: "02",
    icon: Cloud,
    img: withBasePath("/assets/images/pillars/cloud.jpg"),
    href: "/services/cloud",
    borderColor: "#ffffff",
    isWhiteBg: false,
    rotateDeg: -15,
  ...
  },
  {
    ...
    num: "03",
    icon: Scale,
    img: withBasePath("/assets/images/pillars/grc.jpg"),
    href: "/services/grc",
    borderColor: "#ffffff",
    isWhiteBg: true,
    rotateDeg: -15,
  ...
  },
  {
    ...
    num: "04",
    icon: RefreshCw,
    img: withBasePath("/assets/images/pillars/bcm.jpg"),
  ...
  },
  {
    ...
    num: "05",
    icon: Bot,
    img: withBasePath("/assets/images/pillars/ai.jpg"),
    href: "/services/ai",
  ...
  },
  {
    ...
    num: "06",
    icon: Settings,
    img: withBasePath("/assets/images/pillars/dt.jpg"),
  ...
  },
  {
    ...
    num: "07",
    icon: Server,
    img: withBasePath("/assets/images/pillars/infrastructure.jpg"),
